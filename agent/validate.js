...
function validateDraft(draft, corpus) {
  ...
  if (!["strategy-flow-input/0.2", "strategy-flow-input/0.3", "strategy-flow-input/0.4"].includes(draft?.candidate?.schemaVersion)) errors.push("candidate must be strategy-flow-input/0.2, 0.3, or 0.4");
